...
layout: post
tags: [rev, ctf, code]
cover: assets/images/posts/angr_6.png
class: post-template
navigation: True
author: fanpu
---

Hello from Part 6 of this series on cracking CMU's Bomblab with Angr. If you are new here, I would recommend starting with part 1 [here](https://fanpu.io/breaking-cmu-bomblab-with-angr-for-fun-and-profit).
